# Operator Quickstart — cloud-itonami-isic-4774

Shortest path from clone to a verified local dry-run for **ISIC 4774** (`cloud-itonami-isic-4774`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4774.git
